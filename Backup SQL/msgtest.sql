...
--
-- Host: localhost:3306
-- Generation Time: Jul 07, 2025 at 10:01 AM
...
(14, '', '', '', '2025-06-12 10:51:24', '2025-07-07 15:38:31'),
...
(27, '', '', '', '2025-06-17 14:30:06', '2025-07-07 14:08:52'),
...
CREATE TABLE `product_list` (
  ...
  `shipping_price_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(22, 7, 0, 1000, 40.00),
(23, 7, 1001, 2000, 50.00),
(24, 7, 2001, 3000, 65.00),
(25, 7, 3001, 4000, 75.00),
(26, 7, 4001, 5000, 90.00),
(27, 7, 5001, 6000, 100.00),
(28, 7, 6001, 7000, 120.00),
(29, 7, 7001, 8000, 135.00),
(30, 7, 8001, 9000, 140.00),
(31, 7, 9001, 10000, 150.00),
(32, 7, 10001, 11000, 160.00),
(33, 7, 11001, 12000, 170.00),
(34, 7, 12001, 13000, 180.00),
(35, 7, 13001, 14000, 190.00),
(36, 7, 14001, 15000, 200.00),
(37, 7, 15001, 16000, 210.00),
(38, 7, 16001, 17000, 220.00),
(39, 7, 17001, 18000, 230.00),
(40, 7, 18001, 19000, 240.00),
(41, 7, 19001, 20000, 250.00),
(42, 7, 20001, 25000, 400.00);
...
ALTER TABLE `product_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_id` (`category_id`),
  ADD KEY `fk_shipping_price` (`shipping_price_id`);
