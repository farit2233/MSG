              ...
              <div class="dropdown-menu-notify">
                <div class="dropdown-menu dropdown-menu-right ">
                  ...
                  <?php else: ?>
                    ...
                    {
                      return ['ยังไม่ชำระเงิน', 'รอตรวจสอบ', 'ชำระเงินแล้ว', 'ชำระเงินล้มเหลว', 'กำลังยกเลิกคำสั่งซื้อ', 'คืนเงินแล้ว'][$status] ?? 'N/A';
                    }
                    function get_delivery_text($status)
                    {
                      return ['ตรวจสอบคำสั่งซื้อ', 'กำลังเตรียมของ', 'แพ็กของแล้ว', 'กำลังจัดส่ง', 'จัดส่งสำเร็จ', 'จัดส่งไม่สำเร็จ', 'กำลังยกเลิกคำสั่งซื้อ', 'คืนของระหว่างทาง', 'คืนของแล้ว', 'ยกเลิกแล้ว'][$status] ?? 'N/A';
                    }
