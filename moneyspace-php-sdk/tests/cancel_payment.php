...
function cancel_payment($data) {
    ...
    if ($http != 200) {
        return json_encode(array(array("status"=> "error", "message" => "Internal Server Error")));
    }
    return $response;
}
?>
...
<head>
    ...
    <title>Cancel Payment Document</title>
</head>
<body>
    <div class="container">
    <div class="container text-center">
        <h1>Cancel Payment example</h1>
    </div>
    <a href="/index.php">Go Home</a> | 
    <a href="/samples_code/cancel_payment.md" target="blank">View the complete code</a>
    <form method="post">
        <div class="form-row">
