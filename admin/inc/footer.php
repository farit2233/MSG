<script>
  $(document).ready(function() {
    ...
    window.uni_modal_tracking = function($title = '', $url = '', $size = "") {
      start_loader()
      $.ajax({
        url: $url,
        error: err => {
    ...
    window.uni_modal_slip = function($title = '', $url = '', $size = "") {
      start_loader()
      $.ajax({
        url: $url,
        error: err => {
...
<footer class="main-footer text-sm">
  ...
  <div class="float-right d-none d-sm-inline-block">
    <b><?php echo $_settings->info('short_name') ?> (by: <a href="mailto:faritre5566@gmail.com" target="blank">Media & Traning Co., Ltd.</a> )</b> v1.0
  </div>
</footer>
</div>
<!-- ./wrapper -->
