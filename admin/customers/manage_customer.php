							...
							<form id="update-form" action="" method="post">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										...
										<?php $password = isset($_GET['id']);
										if (!$password): ?>
											<div class="form-group">
												<label for="password" class="control-label">รหัสผ่าน <span class="text-danger">*</span></label>
											...
											<div class="form-group">
												<label for="cpassword" class="control-label">ยืนยันรหัสผ่าน <span class="text-danger">*</span></label>
										...
										<?php else: ?>
											<div class="form-group">
												...
												<a class="form-control" type="button" id="newpassword" data-id="<?= isset($id) ? $id : '' ?>">เปลี่ยนรหัสผ่าน <i class="fa fa-pencil"></i></a>
											</div>
										<?php endif; ?>
									</div>
